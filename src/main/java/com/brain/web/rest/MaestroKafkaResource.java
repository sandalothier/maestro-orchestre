...
@RestController
@RequestMapping("/api/maestro-kafka")
public class MaestroKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MaestroKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MaestroKafkaResource(KafkaProperties kafkaProperties) {
